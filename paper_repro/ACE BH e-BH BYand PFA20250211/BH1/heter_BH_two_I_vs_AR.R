rm(list = ls())
setwd("D:/R/SAVE/Save2022_10_14/BH1")
t1 <- Sys.time()
p <- 2000; n1 <- 600 ; n2 <- 800; K1 <- 1; K2 <- 2; lb <- 0.1; ub <- 0.4; v <- 4
# p <- 2000; n1 <- 50 ; n2 <- 100; K1 <- 1; K2 <- 2; lb <- 0.8; ub <- 1.1; ita <- 1; v <- 4
PP <- 0.2
gama<-0.05
